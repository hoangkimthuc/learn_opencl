...
int main() {
    ...
    float* tileA = (float*)malloc(TILE_SIZE * TILE_SIZE * sizeof(float));
    float* tileB = (float*)malloc(TILE_SIZE * TILE_SIZE * sizeof(float));
    ...
    cl_mem bufferTileA = clCreateBuffer(context, CL_MEM_READ_WRITE, TILE_SIZE * TILE_SIZE * sizeof(float), NULL, NULL);
    cl_mem bufferTileB = clCreateBuffer(context, CL_MEM_READ_WRITE, TILE_SIZE * TILE_SIZE * sizeof(float), NULL, NULL);
    ...
    clSetKernelArg(kernel, 5, sizeof(cl_mem), &bufferTileA);
    clSetKernelArg(kernel, 6, sizeof(cl_mem), &bufferTileB);
    ...
    clEnqueueReadBuffer(queue, bufferTileA, CL_TRUE, 0, TILE_SIZE * TILE_SIZE * sizeof(float), tileA, 0, NULL, NULL);
    clEnqueueReadBuffer(queue, bufferTileB, CL_TRUE, 0, TILE_SIZE * TILE_SIZE * sizeof(float), tileB, 0, NULL, NULL);
